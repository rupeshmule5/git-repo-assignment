...
@Service
public class HottestRepoCreatedLastWeekServiceImpl implements HottestRepoCreatedLastWeekService {
	...
	public HottestRepoCreatedLastWeekServiceImpl(RestTemplate restTemplate) {
		this.restTemplate = restTemplate;
	}

	@HystrixCommand(commandProperties = {
			@HystrixProperty(name = "execution.timeout.enabled", value = "false") }, fallbackMethod = "reliable")
	public List<HottestRepoCreatedLastWeek> repoCreatedLastWeek(String limit) {

		LOGGER.info("---------- In the HottestRepoCreatedLastWeekServiceImpl ---------- ");
		...
		try {
			...
			List<HottestRepoCreatedLastWeek> numberFormatErrorMessages = new ArrayList<HottestRepoCreatedLastWeek>();
			HottestRepoCreatedLastWeek limitValueError = new HottestRepoCreatedLastWeek();
	...
	public List<HottestRepoCreatedLastWeek> reliable(String limit) {
		LOGGER.info("----------- In netflix relible method  ----------------");
		List<HottestRepoCreatedLastWeek> fallbackObject = new ArrayList<HottestRepoCreatedLastWeek>();
		HottestRepoCreatedLastWeek fallbackMessage = new HottestRepoCreatedLastWeek();
